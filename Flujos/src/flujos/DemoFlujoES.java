...
// Ahora se piiede ii sare1readT , ine0 " apropiado" :
...
RandomAccessFile rf = new RandomAccessFile("rprueba.txt", "rw");
for(int i = 0; i < 10; i++)
//rf.writeDouble(i*1.414);
rf.writeChars("hola claudio como estas");

rf.close();
rf=new RandomAccessFile("rprueba.txt", "rw");
rf.seek (5*8);
rf.writeDouble (47.0001);
rf.close ( ) ;
rf = new RandomAccessFile ("rprueba.txt", "r" );
